...
<div>
  ...
  <div v-bind:class="{'alert_modal_frame_small':true}">
    ...
    <div class="alert_modal_save_button">
      <span class="alert_modal_ok" @click="$emit('closemodal', open)">확인</span>
    </div>
  </div>  
</div>
</template>
